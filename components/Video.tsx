...
<video 
                className="flex max-h-96 rounded-md playsinline bg-[url('https://firebasestorage.googleapis.com/v0/b/suzume-82712.appspot.com/o/1.PNG?alt=media&token=dce2a480-4f1a-48ca-8872-f0dfc42a5a7b')"
                controls
            >
